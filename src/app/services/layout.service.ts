...
export class LayoutService {
    ...
    private _rightMenuOpenSubject = new BehaviorSubject<boolean>(false);
    rightMenuOpen$ = this._rightMenuOpenSubject.asObservable();

    private _rightSidenavCollapsedOpenSubject = new BehaviorSubject<boolean>(false);
    rightSidenavCollapsedOpen$ = this._rightSidenavCollapsedOpenSubject.asObservable();
    ...
    openRightMenu() {
        this._rightMenuOpenSubject.next(true);
    }

    closeRightMenu() {
        this._rightMenuOpenSubject.next(false);
    }

    expandRightSidenav() {
        this._rightSidenavCollapsedOpenSubject.next(false);
    }

    collapseOpenRightSidenav() {
        this._rightSidenavCollapsedOpenSubject.next(true);
    }
}

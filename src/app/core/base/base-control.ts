...
export class BaseControl implements MatFormFieldControl<any>, ControlValueAccessor, OnDestroy {
  ...
  constructor(private __injec: Injector) {
    this.__elementRef=__injec.get(ElementRef)
  }
  ...
  onFocusOut(event: FocusEvent) {
    if (!this.__elementRef.nativeElement.contains(event.relatedTarget as Element)) {
      // this.touched = true;
      this.focused = false;
      // this.onTouched();

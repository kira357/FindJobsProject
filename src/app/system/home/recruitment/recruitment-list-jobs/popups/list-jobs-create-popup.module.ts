...
import { ListJobsCreatePopupRoutingModule } from './list-jobs-create-popup-routing.module';
...
@NgModule({
  declarations: [ListJobsCreatePopupComponent],
  imports: [
    CommonModule,
    ListJobsCreatePopupRoutingModule,
    CommonModule,
    FlexLayoutModule,
    MatInputModule,
    MatIconModule,
  ...
  entryComponents: [ListJobsCreatePopupComponent],
})
